...
{
    let page= await Pageservice.UpdateLongtokenPage(req.body.access_token,req.body.id);
    console.log(page);
}
let GetAllUser = async (req,res) =>
{
    let all_user= await Pageservice.UpdateLongtokenPage(req.body.access_token,req.body.id);
    console.log(page);
}
module.exports = {
