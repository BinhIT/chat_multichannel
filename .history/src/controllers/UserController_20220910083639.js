...
let GetLongAcessToken = async (req,res) =>{
    let post_token = await userSevice.Post_acess_token_by_id_user(req.body.access_token,req.params.id);
    console.log
}
module.exports = {
    ...
    GetLongAcessToken:GetLongAcessToken
}