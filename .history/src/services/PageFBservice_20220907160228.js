        ...
        try {
            ...
            if (pagecheck) {
                Pagedata.status= true,
                 Pagedata.errCode = 0;
                 Pagedata.errMsg = "Tài khoản này đã đã tồn tại trong hệ thống ! Tiến hành đăng nhập !";
                 Pagedata.user = user;
            resolve( Pagedata)
            } else {
                 Pagedata.status= false,
                 Pagedata.errCode = 0;
                 Pagedata.errMsg = "Tài khoản này đã đã tồn tại trong hệ thống ! iến hành đăng nhập !";
                 Pagedata.user = user;
            resolve( Pagedata)
            }
        } catch (e) {
